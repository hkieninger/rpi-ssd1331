...
{   Write_Command(0x22);	// Draw Rectangle
	Write_Command(a);		// Column Address of Start
	Write_Command(b);		// Row Address of Start	
	Write_Command(c);          // Column Address of End 
	Write_Command(d);          // Row Address of End
...
//
//    a: A[6:0]: Set number of column as horizontal scroll offset
//       Range: 0d-95d ( no horizontal scroll if  equals to 0)
//    b: B[5:0]: Define start row address	  0-63
//    c: C[6:0]: Set number of rows to be horizontal scrolled 	 0-95
//    d: D[5:0]: Set number of row as vertical scroll offset 	 0-63
...
{
	Write_Command(0x27);			// Horizontal Scroll Setup
	Write_Data(a);
	Write_Data(b);
	Write_Data(c);
	Write_Data(d);
	Write_Data(e);
	//Write_Data(f);
	Write_Command(0x2F);			// Activate Horizontal Scroll
//	Delay(f);
}
